...
rc = load_result("../experiments/data/parallel/RC_HoldAndKill.csv", threshold_1_2)
...
f1 = load_result("../experiments/data/parallel/F1_HoldAndKill.csv", 5)
...
dcm = load_result("../experiments/data/default/DCM_HoldAndKill_n5_t100.csv", 0.24)

# ╔═╡ 5573a92e-224c-4850-9dea-2e122195e4de
css = load_result("../experiments/data/default/CSS_HoldAndKill_n5_t100.csv", 2.37)

# ╔═╡ 4ec2ad2d-4a3b-472f-93f6-26a913453e59
cc2 = load_result("../experiments/data/default/CC2_HoldAndKill_n5_t100.csv", 2)
